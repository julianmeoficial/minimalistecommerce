                ...
                <div className="canvas">
                    ...
                    <div id="card">
                        <div className="card-content">
                            ...
                            <p id="prompt">FOTO DE PERFIL DEL USUARIO</p>
                            <div className="title">USUARIO<br />BETA</div>
                            <div className="glowing-elements">...                 <div className="glow-1" />
                                <div className="glow-2" />
                                <div className="glow-3" />
                            </div>
                            <div className="subtitle">
                                <span> </span>
                                <span className="highlight">TIPO DE USUARIO</span>
                            </div>
